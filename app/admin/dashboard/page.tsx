      ...
      <CardContent>
        <div className="bg-gradient-to-r from-primary/10 to-primary/5 p-4 rounded-lg border border-primary/20">
          <p className="text-sm text-muted-foreground">
            💡 <strong>Dica:</strong> Gere um único QR Code e imprima para todas as mesas. Seus clientes poderão escanear e visualizar o menu instantaneamente no celular!
          </p>
        </div>
      </CardContent>
    </Card>
    ...
    <Card className="mb-8">
      <CardHeader>
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <CardDescription>
              Gere um QR Code que leva o cliente direto à avaliação no Google
            </CardDescription>
          </div>
      ...
      <CardContent>
        <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 p-4 rounded-lg border border-yellow-200">
          <p className="text-sm text-muted-foreground">
            💬 <strong>Dica:</strong> Incentive seus clientes a deixarem uma avaliação no Google. Isso ajuda a fortalecer a reputação do restaurante!
          </p>
        </div>
      </CardContent>
    </Card>
